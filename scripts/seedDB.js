...
const dogSeed = [
    ...
    {OriginId:2, DogStatusId: 3, CurrentlyWithId:18, currentlyWithSince: Date.now(), name: "Patches", gender: "male", dob: "2016-05-01", microchipId:"8645556", isPurebred: false, secondaryBreed: "border collie", pullCost:200, behaviorIssues: false, medicalIssues: false, size: "small", weight:40.2, coat: "blue merle" },
    ...
    {OriginId:5, CurrentlyWithId:14, currentlyWithSince: Date.now(), name: "Abby", gender: "female", dob: "2020-12-01", isPurebred: true, pullCost:200, behaviorIssues:true, medicalIssues: false, size: "mini", weight:22, coat: "red tri-color" },
    ...
    {OriginId:1, DogStatusId: 3,CurrentlyWithId:15, currentlyWithSince: Date.now(), name: "Maya", gender: "female", dob: "2016-05-01", isPurebred: true, pullCost:200, behaviorIssues:true, medicalIssues: false, size: "mini", weight:25, coat: "red merle" },
    ...
    {OriginId:3, DogStatusId: 3,CurrentlyWithId:14, currentlyWithSince: Date.now(), name: "Champ", gender: "male", dob: "2020-12-01", MicrochipId:"522555", microchipMfgId: 8, isPurebred: true, pullCost:200, behaviorIssues:true, medicalIssues: false, size: "small", weight:40.2, coat: "black tri-color" },
    ...
    {OriginId:5, DogStatusId: 3, CurrentlyWithId:16, currentlyWithSince: Date.now(), name: "Xena", gender: "female", dob: "2010-11-01", microchipId:"53637889", MicrochipMfgId: 8, isPurebred: true, pullCost:200, behaviorIssues:true, medicalIssues: false, size: "mini", weight:19, coat: "blue merle" },
    {OriginId:7, DogStatusId: 2, CurrentlyWithId:29, currentlyWithSince: Date.now(), name: "Reina", gender: "female", dob: "2016-05-01", isPurebred: false, secondaryBreed: "german shepherd", pullCost:200, behaviorIssues:false, medicalIssues: false, size: "medium", weight: 50, coat: "red tri-color" },
    {OriginId:7, DogStatusId: 2, CurrentlyWithId:29, currentlyWithSince: Date.now(), name: "Titan", gender: "male", dob: "2010-11-01", isPurebred: true, pullCost:200, behaviorIssues:false, medicalIssues: false, size: "large", weight:67.78, coat: "black" },
    {OriginId:10, DogStatusId: 3, CurrentlyWithId:15, currentlyWithSince: Date.now(), name: "Billie", gender: "female", dob: "2020-12-01", microchipId:"5966", MicrochipMfgId: 8, isPurebred: false, secondaryBreed: "pit", pullCost:200, behaviorIssues:true, medicalIssues: false, size: "large", weight: 70, coat: "blue merle" },
    {OriginId:9, DogStatusId: 6, CurrentlyWithId:28, currentlyWithSince: Date.now(), name: "Spot", gender: "male", dob: "2020-12-01", microchipId:"5967", MicrochipMfgId: 8, isPurebred: false, secondaryBreed: "poodle", pullCost:200, behaviorIssues:true, medicalIssues: false, size: "large", weight: 70, coat: "blue merle" },
    {OriginId:10, DogStatusId: 3, CurrentlyWithId:31, currentlyWithSince: Date.now(), name: "Daenarys", gender: "female", dob: "2015-12-01", microchipId:"55645966", MicrochipMfgId: 8, isPurebred: false, secondaryBreed: "pit", pullCost:200, behaviorIssues:true, medicalIssues: false, size: "large", weight: 70, coat: "double merle" },
    {OriginId:9, DogStatusId: 6, CurrentlyWithId:31, currentlyWithSince: Date.now(), name: "Drogon", gender: "male", dob: "2016-12-01", microchipId:"59865667", MicrochipMfgId: 8, isPurebred: false, pullCost:200, behaviorIssues:true, medicalIssues: false, size: "large", weight: 70, coat: "red bi-color" }
]; 
